...
@section('content')
    @parent
    <x-content>
        <h2 class="text-4xl font-bold dark:text-white mb-5 ml-1">Create Project</h2>
        <form class="px-2" method="POST" action="/projects">
            @csrf
            <div class="mb-6">
            ...
            <div class="mb-6">
                ...
                @else
                    border-gray-300
                @enderror"
                    placeholder="Write the description of the project here..." required></textarea>
                @error('description')
                    <p id="filled_error_help" class="mt-2 text-xs text-red-600 dark:text-red-400">
                        {{ $message }}
                    </p>
